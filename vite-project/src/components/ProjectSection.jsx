...
const projects=[
    ...
    ,
 {
...

    {
        ...
        id:4,
        title:"Intelligent-Patient-Admission-Management-System",
...
<div key={key} className="group bg-card rounded-lg overflow-hidden shadow-xs shadow-neutral-800 card-hover">
